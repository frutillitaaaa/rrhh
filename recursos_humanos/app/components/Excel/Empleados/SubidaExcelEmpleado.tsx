...
export default function SubirExcelEmpleados () {
    const inputRef = useRef<HTMLInputElement>(null)
    const variablesPermitidas = ["rut", "nombre", "apellido", "correo", "telefono", "cargo", "departamento", "fecha_contratacion"];
